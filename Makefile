...
PARAMSEW = -DC2=$(C2) -DTAU=$(TAU) -DMONITOR=$(MONITOR) -DNBINS=100 -DDt=$(Dt) -DMONITORCONF=$(MONITORCONF) #-DDOUBLE  
PARAMSKPZ = -DC2=$(C2) -DKPZ=1.0 -DTAU=$(TAU) -DMONITOR=$(MONITOR) -DNBINS=100 -DDt=$(Dt) -DMONITORCONF=$(MONITORCONF) #-DDOUBLE  
PARAMSANH = -DC2=$(C2) -DC4=1.0 -DTAU=$(TAU) -DMONITOR=$(MONITOR) -DNBINS=100 -DDt=$(Dt) -DMONITORCONF=$(MONITORCONF) #-DDOUBLE  
PARAMSPUREANH = -DC12=1.0 -DTAU=$(TAU) -DMONITOR=$(MONITOR) -DDt=$(Dt) -DNBINS=100 -DMONITORCONF=$(MONITORCONF) #-DDOUBLE  
PARAMSALM = -DC2=$(C2) -DC4=$(C4) -DC12=$(C12) -DTAUINFINITO -DMONITOR=$(MONITOR) -DNBINS=100 -DDt=$(Dt) -DMONITORCONF=$(MONITORCONF) #-DDOUBLE  
